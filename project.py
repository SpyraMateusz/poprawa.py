...
def main():
    ...
    Pyandrei = Striker(20, 0, 10, 100, 10, GREEN)
    You = Striker(WIDTH - 30, 0, 10, 100, 10, GREEN)
    ball = Ball(WIDTH // 2, HEIGHT // 2, 7, 7, WHITE)

    listOfPlayers = [Pyandrei, You]

    # Initial parameters of the players
    PyandreiScore, YouScore = 0, 0
    PyandreiYFac, YouYFac = 0, 0
    ...
    while running:
        ...
        Pyandrei.update(PyandreiYFac)
        You.update(YouYFac)
        point = ball.update()

        # -1 -> Pyandrei has scored
        # +1 -> You has scored
        ...
        Pyandrei.displayScore("Pyandrei : ",
                           PyandreiScore, 100, 20, WHITE)
        You.displayScore("You : ",
                           YouScore, WIDTH - 100, 20, WHITE)
